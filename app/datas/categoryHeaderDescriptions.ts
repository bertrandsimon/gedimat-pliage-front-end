export const categoryDescriptions = [
  ...
  {
    category: 'amenagement_interieur',
    category_title: 'Amenagement intérieur',
    category_image: '/images/inspirations/inspirations/7.jpg',
    category_description:
      'Solutions de design, confort et fonctionnalités pour tous les espaces.',
  },
  {
    category: 'amenagement_extérieur',
    category_title: 'Amenagement extérieur',
    category_image: '/images/inspirations/inspirations/7.jpg',
    category_description:
      'Esthétisme et durabilité pour votre espace extérieur.',
  },
  {
    category: 'quincaillerie_outillage',
